...
ACT_JSON = f'{UF_ROOT}/data/hmdb51_actions.json'
TR_SPLIT = f'{UF_ROOT}/data/hmdb51/train-frames'
TS_SPLIT = f'{UF_ROOT}/data/hmdb51/test-frames'
...
train_cfg = dict(
    max_epochs=20,     # UCF101 建议 20~30 起步
    val_begin=0,
    val_interval=1,
